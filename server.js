...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      imgSrc:     ["'self'", 'data:', 'blob:', 'https://www.google.com', 'https://www.googleadservices.com'],
      scriptSrc:  ["'self'", "'unsafe-inline'", 'https://accounts.google.com/gsi/client', 'https://www.googletagmanager.com'],
      connectSrc: ["'self'", 'https://open.er-api.com', 'https://accounts.google.com', 'https://www.googletagmanager.com', 'https://www.google.com', 'https://googleads.g.doubleclick.net'],
