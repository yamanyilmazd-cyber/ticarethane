    ...
    '<div class="auth-page">' +
      '<div class="auth-card">' +
        ...
        '<form id="loginForm">' +
          ...
          '<div class="form-group mb-4"><label class="form-label">Şifre <span class="req">*</span></label><div style="position:relative;display:flex"><div style="position:relative;display:flex"><input type="password" name="password" class="form-control" placeholder="Şifreniz" required style="border-radius:4px 0 0 4px" /><button type="button" onclick="var i=this.previousElementSibling;i.type=i.type===&#39;password&#39;?&#39;text&#39;:&#39;password&#39;;this.textContent=i.type===&#39;password&#39;?&#39;Göster&#39;:&#39;Gizle&#39;" style="border:1px solid #ced4da;border-left:0;border-radius:0 4px 4px 0;background:#f8f9fa;cursor:pointer;padding:0 12px;white-space:nowrap;font-size:13px">Göster</button></div><button type="button" onclick="var i=this.previousElementSibling;i.type=i.type===&#39;password&#39;?&#39;text&#39;:&#39;password&#39;;this.textContent=i.type===&#39;password&#39;?&#39;Göster&#39;:&#39;Gizle&#39;" style="border:1px solid #ced4da;border-left:0;border-radius:0 4px 4px 0;background:#f8f9fa;cursor:pointer;padding:0 12px;white-space:nowrap;font-size:13px">Göster</button></div></div>' +
